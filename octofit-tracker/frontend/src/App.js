  ...
  return (
    <Router>
      <div className="container mt-4">
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary octofit-nav mb-4 rounded">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="octofit-heading"><h1>Welcome to Octofit Tracker!</h1></div>} />
        </Routes>
      </div>
    </Router>
  );
